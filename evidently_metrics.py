...
data_path = 'C:/Users/sebas/Desktop/mlops-zoomcamp-main/mlops-zoomcamp-sebasfac/Project/preprocessed_data'
...
def calculate_metrics_postgresql(curr, i):
    ...
    curr.execute(
		...
		(prediction_drift, num_drifted_columns, share_missing_values, prod_year_median, mileage_median, doors_median, airbags_median)
	)
